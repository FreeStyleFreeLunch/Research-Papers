...
-----|----|-----|-----|-----|-----
2024|VisionLLaMA|ECCV 2024|[VisionLLaMA: A Unified LLaMA Backbone for Vision Tasks](https://www.ecva.net/papers/eccv_2024/papers_ECCV/papers/08280.pdf)|None|对视觉语言大模型的大一统backbone进行了探讨
